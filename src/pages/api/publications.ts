...
const filePath = path.resolve('src/data/publications.json');
...
export const PUT: APIRoute = async ({ request, cookies }) => {
  ...
  try {
    ...
    data[index] = {
      ...
      journal: body.journal !== undefined ? body.journal : data[index].journal,
      journal_en: body.journal_en !== undefined ? body.journal_en : data[index].journal_en,
      details: body.details !== undefined ? body.details : data[index].details,
